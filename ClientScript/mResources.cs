...
public class mResources
{
    ...
    public static string input_quantity_to_buy = string.Empty;
    ...
    public static string voice_autoplay_world = string.Empty;
    public static string voice_autoplay_private = string.Empty;
