public class T1 : mResources
{
    public static void load()
    {
        ...
        mResources.CHAR_ORDER = new string[10] { "Thách đấu", "Luyện tập", "Cừu sát", "Kết bạn", "Mời vào bang", "Phục hồi", "Xem thông tin", "Chat riêng", "Bái sư", "Chặn xin vào tộc" };
        ...
        mResources.voice_map_listen = "Nghe VoiceChat Map";
        ...
        mResources.input_quantity_to_buy = "Nhập số lượng muốn mua";
        ...
        mResources.not_enough_luong_world_channel = "Bạn không đủ vàng để chat kênh thế giới";
        mResources.world_channel_5_luong = "Chat kênh thế giới (200tr vàng)";
