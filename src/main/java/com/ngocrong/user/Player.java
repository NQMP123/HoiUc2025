...
//                }
                ...
                if (item2.isDoHD()) {
                    ...
                    int itemGender = item2.template.gender == 3 ? this.gender : item2.template.gender;
...
//        }
    ...
    public String getRewardEventTet() {
        return String.format("[%d,%d,%d]", pointRaiti,0 , pointThoiVang);
    }
