    ...
    internal class Controller2
    {
                    ...
                    case -113:
                        {
                            ...
                            for (int num35 = 0; num35 < 10; num35++)
                            {
                                ...
                                //UnityEngine.Debug.LogError("Arr : " + array10[num35]);
                            }
                    ...
                    case 124:
                        {
                            ...
                            Npc npc = GameScr.findNPCInMap(num26);
                            if (npc != null)
                            {
                                npc.addInfo(text3);
                            }
                    ...
                    case -100:
                        {
                            ...
                            for (int i = 0; i < num; i++)
                            {
                                ...
                                Char.myCharz().arrItemShop[b][i].buyDiamond = msg.reader().readInt();
        ...
        private static void readActionBoss(Message msg, int actionBoss)
        {
            try
            {
                ...
                NewBoss newBoss = Mob.getNewBoss((sbyte)idBoss);
                if (newBoss == null)
                {
                    return;
                }
